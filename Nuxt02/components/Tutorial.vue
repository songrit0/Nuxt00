    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      -/562
        ...
        <p class="mt-3 text-gray-600">
          We recommend you take a look at the s151<a href="https://nuxtjs.org" target="_blank" class="button--doc text-green-500 hover:underline">Nuxt Documentation</a>, whether you are new or have previous experience with the framework.<br>
        </p>
